...
- `grain_decision.json`: frozen v1 parent/lifecycle row-grain decision, canonical-schema freeze state, synthetic-validated PERMIT transformer gate, and explicitly rejected alternatives.
