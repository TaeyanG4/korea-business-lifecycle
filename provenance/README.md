...
- `history_observation_strategy.json`: network-free current-scale request planning split at the 2026-07-01 reform boundary: conservative 276-code planning before the reform and current-244-only planning after it; no cadence is approved because the pre-reform old/new partition domain remains unresolved.
