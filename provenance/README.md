...
- `history_authority_partition_probe_plan.json`: exact 384-request DRY_RUN-by-default plan for count-only probing of all 32 deleted codes across three sources and four dates.
